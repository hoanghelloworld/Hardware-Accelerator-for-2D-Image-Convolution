...
HLS_SOURCES = ../../../../test_conv.cpp ../../../../testutils.cpp ../../../../conv.cpp

TARGET := csim.exe

AUTOPILOT_ROOT := D:/Vivado/2018.1
...
ifndef AP_GCC_PATH
  AP_GCC_PATH := D:/Vivado/2018.1/msys/bin
endif
...
$(ObjDir)/test_conv.o: ../../../../test_conv.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../test_conv.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
